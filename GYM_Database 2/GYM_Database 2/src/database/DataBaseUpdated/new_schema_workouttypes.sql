...
LOCK TABLES `workouttypes` WRITE;
/*!40000 ALTER TABLE `workouttypes` DISABLE KEYS */;
INSERT INTO `workouttypes` VALUES ('AEROBIC'),('BALANCE'),('STRENGTH'),('STRETCHING');
/*!40000 ALTER TABLE `workouttypes` ENABLE KEYS */;
UNLOCK TABLES;
